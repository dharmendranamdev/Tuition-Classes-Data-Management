...
public class PastStudent extends JFrame implements ActionListener{
    
    JTable t1;
    JButton b1;
    String x[] = {"Sr.No","Reg Number","Password", "Name", "Gender", "Address", "State", "City", "Email", "PhoneNo"," Left Date & Time"};
    String y[][] = new String[100][11];
    int i=0,j =0;
    public PastStudent(){
        super("Past Student Details");
        setSize(1200,650);
        setLocation(100,100);
        ...
        try{
            ...
            Conne c1 = new Conne();
            String q = "select * from paststudent";
